...
public class MoonlitBook {
	 ...
	 */
	public static void moonlit() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MoonlitBook window = new MoonlitBook();
	...
	private void initialize() {
		...
		JPanel moonlit_vol1 = new JPanel();
		moonlit_vol1.setBackground(Color.WHITE);
		moonlit_vol1.setBounds(0, 0, 1184, 661);
		layeredPane.add(moonlit_vol1);
		
		JPanel moonlit_vol2 = new JPanel();
		moonlit_vol2.setBackground(Color.WHITE);
		moonlit_vol2.setBounds(0, 0, 1184, 661);
		layeredPane.add(moonlit_vol2);
		
		JPanel moonlit_vol3 = new JPanel();
		moonlit_vol3.setBackground(Color.WHITE);
		moonlit_vol3.setBounds(0, 0, 1184, 661);
		layeredPane.add(moonlit_vol3);
		
		JPanel moonlit_vol4 = new JPanel();
		moonlit_vol4.setBackground(Color.WHITE);
		moonlit_vol4.setBounds(0, 0, 1184, 661);
		layeredPane.add(moonlit_vol4);
		moonlit_vol1.setLayout(null);
				
		JLabel vol1 = new JLabel("");
		vol1.setBounds(-8, 5, 1200, 700);
		vol1.setVerticalAlignment(SwingConstants.TOP);
		vol1.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\moonlit_vol1 (1).png"));
		vol1.setHorizontalAlignment(SwingConstants.CENTER);
		moonlit_vol1.add(vol1);
		...
		moonlit_vol1.add(back_button_1);
		moonlit_vol2.setLayout(null);
		
		JLabel vol2 = new JLabel("");
		vol2.setBounds(-8, 5, 1200, 700);
		vol2.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\moonlit_vol2.png"));
		vol2.setHorizontalAlignment(SwingConstants.CENTER);
		moonlit_vol2.add(vol2);	
		...
		moonlit_vol2.add(back_button_2);
		moonlit_vol3.setLayout(null);
		
		vol3 = new JLabel("");
		vol3.setBounds(-8, 5, 1200, 700);
		vol3.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\moonlit_vol3 (1).png"));
		vol3.setHorizontalAlignment(SwingConstants.CENTER);
		moonlit_vol3.add(vol3);
		...
		moonlit_vol3.add(back_button_3);
		moonlit_vol4.setLayout(null);
		
		JLabel vol4 = new JLabel("");
		vol4.setBounds(-8, 5, 1200, 700);
		vol4.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\moonlit_vol4 (2).png"));
		vol4.setHorizontalAlignment(SwingConstants.CENTER);
		moonlit_vol4.add(vol4);
		...
		moonlit_vol4.add(back_button_4);
	}
}
