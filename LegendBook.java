...
public class LegendBook {
	...
	public static void legend() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LegendBook window = new LegendBook();
	...
	private void initialize() {
		...
		JPanel legend_vol1 = new JPanel();
		legend_vol1.setBackground(Color.WHITE);
		legend_vol1.setBounds(0, 0, 1184, 661);
		layeredPane.add(legend_vol1);
		
		JPanel legend_vol2 = new JPanel();
		legend_vol2.setBackground(Color.WHITE);
		legend_vol2.setBounds(0, 0, 1184, 661);
		layeredPane.add(legend_vol2);
		
		JPanel legend_vol3 = new JPanel();
		legend_vol3.setBackground(Color.WHITE);
		legend_vol3.setBounds(0, 0, 1184, 661);
		layeredPane.add(legend_vol3);
		
		JPanel legend_vol4 = new JPanel();
		legend_vol4.setBackground(Color.WHITE);
		legend_vol4.setBounds(0, 0, 1184, 661);
		layeredPane.add(legend_vol4);
		legend_vol1.setLayout(null);
				
		JLabel vol1 = new JLabel("");
		vol1.setBounds(-8, 5, 1200, 700);
		vol1.setVerticalAlignment(SwingConstants.TOP);
		vol1.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\legend_vol1.png"));
		vol1.setHorizontalAlignment(SwingConstants.CENTER);
		legend_vol1.add(vol1);
		...
		legend_vol1.add(back_button_1);
		legend_vol2.setLayout(null);
		
		JLabel vol2 = new JLabel("");
		vol2.setBounds(-8, 5, 1200, 700);
		vol2.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\legend_vol2.png"));
		vol2.setHorizontalAlignment(SwingConstants.CENTER);
		legend_vol2.add(vol2);	
		...
		legend_vol2.add(back_button_2);
		legend_vol3.setLayout(null);
		
		vol3 = new JLabel("");
		vol3.setBounds(-8, 5, 1200, 700);
		vol3.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\legend_vol3 (1).png"));
		vol3.setHorizontalAlignment(SwingConstants.CENTER);
		legend_vol3.add(vol3);
		...
		legend_vol3.add(back_button_3);
		legend_vol4.setLayout(null);
		
		JLabel vol4 = new JLabel("");
		vol4.setBounds(-8, 5, 1200, 700);
		vol4.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\legend_vol4 (1).png"));
		vol4.setHorizontalAlignment(SwingConstants.CENTER);
		legend_vol4.add(vol4);
