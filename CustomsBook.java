...
public class CustomsBook {
	...
	public static void customs() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CustomsBook window = new CustomsBook();
	...
	private void initialize() {
		...
		JPanel customs_vol1 = new JPanel();
		customs_vol1.setBackground(Color.WHITE);
		customs_vol1.setBounds(0, 0, 1184, 661);
		layeredPane.add(customs_vol1);
		
		JPanel customs_vol2 = new JPanel();
		customs_vol2.setBackground(Color.WHITE);
		customs_vol2.setBounds(0, 0, 1184, 661);
		layeredPane.add(customs_vol2);
		
		JPanel customs_vol3 = new JPanel();
		customs_vol3.setBackground(Color.WHITE);
		customs_vol3.setBounds(0, 0, 1184, 661);
		layeredPane.add(customs_vol3);
		customs_vol1.setLayout(null);
				
		JLabel vol1 = new JLabel("");
		vol1.setBounds(-8, 5, 1200, 700);
		vol1.setVerticalAlignment(SwingConstants.TOP);
		vol1.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\customs_vol1.png"));
		vol1.setHorizontalAlignment(SwingConstants.CENTER);
		customs_vol1.add(vol1);
		...
		customs_vol1.add(back_button_2);
		customs_vol2.setLayout(null);
		
		JLabel vol2 = new JLabel("");
		vol2.setBounds(-8, 5, 1200, 700);
		vol2.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\customs_vol2 (1).png"));
		vol2.setHorizontalAlignment(SwingConstants.CENTER);
		customs_vol2.add(vol2);	
		...
		customs_vol2.add(back_button_1);
		customs_vol3.setLayout(null);
		
		vol3 = new JLabel("");
		vol3.setBounds(-8, 5, 1200, 700);
		vol3.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\customs_vol3.png"));
		vol3.setHorizontalAlignment(SwingConstants.CENTER);
		customs_vol3.add(vol3);
		...
		customs_vol3.add(back_button_3);
	}
}
