...
public class HeartBook {
	...
	public static void heart() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HeartBook window = new HeartBook();
	...
	private void initialize() {
		...
		JPanel heart_vol1 = new JPanel();
		heart_vol1.setBackground(Color.WHITE);
		heart_vol1.setBounds(0, 0, 1184, 661);
		layeredPane.add(heart_vol1);
		
		JPanel heart_vol2 = new JPanel();
		heart_vol2.setBackground(Color.WHITE);
		heart_vol2.setBounds(0, 0, 1184, 661);
		layeredPane.add(heart_vol2);
		
		JPanel heart_vol3 = new JPanel();
		heart_vol3.setBackground(Color.WHITE);
		heart_vol3.setBounds(0, 0, 1184, 661);
		layeredPane.add(heart_vol3);
		
		JPanel heart_vol4 = new JPanel();
		heart_vol4.setBackground(Color.WHITE);
		heart_vol4.setBounds(0, 0, 1184, 661);
		layeredPane.add(heart_vol4);
		heart_vol1.setLayout(null);
				
		JLabel vol1 = new JLabel("");
		vol1.setBounds(-8, 5, 1200, 700);
		vol1.setVerticalAlignment(SwingConstants.TOP);
		vol1.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\heart_vol1.png"));
		...
		heart_vol1.add(back_button_1);
		heart_vol2.setLayout(null);
		
		JLabel vol2 = new JLabel("");
		vol2.setBounds(-8, 5, 1200, 700);
		vol2.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\heart_vol2.png"));
		...
		heart_vol2.add(back_button_2);
		heart_vol3.setLayout(null);
		
		vol3 = new JLabel("");
		vol3.setBounds(-8, 5, 1200, 700);
		vol3.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\heart_vol3.png"));
		...
		heart_vol3.add(back_button_3);
		heart_vol4.setLayout(null);
		
		JLabel vol4 = new JLabel("");
		vol4.setBounds(-8, 5, 1200, 700);
		vol4.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\heart_vol4.png"));
