...
public class DrunkardsBook {
	 ...
	 */
	public static void drunkards() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DrunkardsBook window = new DrunkardsBook();
	...
	private void initialize() {
		...
		JPanel drunkards_vol1 = new JPanel();
		drunkards_vol1.setBackground(Color.WHITE);
		drunkards_vol1.setBounds(0, 0, 1184, 661);
		layeredPane.add(drunkards_vol1);
		
		JPanel drunkards_vol2 = new JPanel();
		drunkards_vol2.setBackground(Color.WHITE);
		drunkards_vol2.setBounds(0, 0, 1184, 661);
		layeredPane.add(drunkards_vol2);
		
		JPanel drunkards_vol3 = new JPanel();
		drunkards_vol3.setBackground(Color.WHITE);
		drunkards_vol3.setBounds(0, 0, 1184, 661);
		layeredPane.add(drunkards_vol3);
		
		JPanel drunkards_vol4 = new JPanel();
		drunkards_vol4.setBackground(Color.WHITE);
		drunkards_vol4.setBounds(0, 0, 1184, 661);
		layeredPane.add(drunkards_vol4);
		drunkards_vol1.setLayout(null);
				
		JLabel vol1 = new JLabel("");
		vol1.setBounds(-8, 5, 1200, 700);
		vol1.setVerticalAlignment(SwingConstants.TOP);
		vol1.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\drunkards_vol1.png"));
		vol1.setHorizontalAlignment(SwingConstants.CENTER);
		drunkards_vol1.add(vol1);
		...
		drunkards_vol1.add(vol2_button1);
		...
		drunkards_vol1.add(vol3_button1);
		...
		drunkards_vol1.add(vol4_button1);
		...
		drunkards_vol1.add(back_button_4);
		drunkards_vol2.setLayout(null);
		
		JLabel vol2 = new JLabel("");
		vol2.setBounds(-8, 5, 1200, 700);
		vol2.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\drunkards_vol2.png"));
		vol2.setHorizontalAlignment(SwingConstants.CENTER);
		drunkards_vol2.add(vol2);	
		...
		drunkards_vol2.add(vol1_button2);
		...
		drunkards_vol2.add(vol3_button2);
		...
		drunkards_vol2.add(vol4_button2);
		...
		drunkards_vol2.add(back_button_3);
		drunkards_vol3.setLayout(null);
		
		vol3 = new JLabel("");
		vol3.setBounds(-8, 5, 1200, 700);
		vol3.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\drunkards_vol3.png"));
		vol3.setHorizontalAlignment(SwingConstants.CENTER);
		drunkards_vol3.add(vol3);
		...
		drunkards_vol3.add(vol1_button3);
		...
		drunkards_vol3.add(vol2_button3);
		...
		drunkards_vol3.add(vol4_button3);
		...
		drunkards_vol3.add(back_button_2);
		drunkards_vol4.setLayout(null);
		
		JLabel vol4 = new JLabel("");
		vol4.setBounds(-8, 5, 1200, 700);
		vol4.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\drunkards_vol4 (1).png"));
		vol4.setHorizontalAlignment(SwingConstants.CENTER);
		drunkards_vol4.add(vol4);
		...
		drunkards_vol4.add(vol1_button4);
		...
		drunkards_vol4.add(vol2_button4);
		...
		drunkards_vol4.add(vol3_button4);
		...
		drunkards_vol4.add(back_button_1);
