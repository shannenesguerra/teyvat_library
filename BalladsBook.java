...
public class BalladsBook {
	 ...
	 */
	public static void ballads() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BalladsBook window = new BalladsBook();
	...
	private void initialize() {
		...
		JPanel ballads_vol1 = new JPanel();
		ballads_vol1.setBackground(Color.WHITE);
		ballads_vol1.setBounds(0, 0, 1184, 661);
		layeredPane.add(ballads_vol1);
		
		JPanel ballads_vol2 = new JPanel();
		ballads_vol2.setBackground(Color.WHITE);
		ballads_vol2.setBounds(0, 0, 1184, 661);
		layeredPane.add(ballads_vol2);
		ballads_vol1.setLayout(null);
				
		JLabel vol1 = new JLabel("");
		vol1.setBounds(-8, 5, 1200, 700);
		vol1.setVerticalAlignment(SwingConstants.TOP);
		vol1.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\ballads_vol1.png"));
		vol1.setHorizontalAlignment(SwingConstants.CENTER);
		ballads_vol1.add(vol1);
		...
		ballads_vol1.add(back_button_2);
		ballads_vol2.setLayout(null);
		
		JLabel vol2 = new JLabel("");
		vol2.setBounds(-8, 5, 1200, 700);
		vol2.setIcon(new ImageIcon("C:\\Users\\shann\\Downloads\\ballads_vol2.png"));
		vol2.setHorizontalAlignment(SwingConstants.CENTER);
		ballads_vol2.add(vol2);	
		...
		ballads_vol2.add(back_button_1);
